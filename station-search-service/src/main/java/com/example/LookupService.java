...
public class LookupService {
    ...
    public CompletableFuture<List<String>> getAllStartingWithAsync(String name) {
        PrefixTree prefixTree = new PrefixTree();
        prefixTree.add(ALL_STATIONS);
        return prefixTree.findAsync(name);
    }
    ...
    private static final List<String> ALL_STATIONS = Arrays.asList(
        ...
        "Bramley (West Yorks) Rail Station",
        ...
        "Brockley Whins Rail Station",
        "Bryn Rail Station",
        "Braystones Rail Station",
        ...
        "Denton Rail Station",
        "Dockyard (Plymouth) Rail Station",
        ...
        "Energlyn & Churchill Park Rail Station",
        "Eridge Rail Station",
        "Erith Rail Station",
        ...
        "Farringdon (London) Rail Station",
        ...
        "Galashiels Rail Station",
        "Smethwick Galton Bridge Rail Station",
        "Smethwick Galton Bridge High Level Rail Station",
        ...
        "Glasgow Queen Street Low Level Rail Station",
        ...
        "Glynde Rail Station",
        "Greenhithe for Bluewater Rail Station",
        "Green Lane Rail Station",
        ...
        "Garston (Herts) Rail Station",
        "Gartcosh Rail Station",
        "Garth (Bridgend) Rail Station",
        "Grove Park Rail Station",
        "Gravesend Rail Station",
        ...
        "Birkenhead Hamilton Square Rail Station",
        ...
        "Heathrow Terminals 1-3 Rail Station",
        ...
        "James Cook University Hospital Rail Station",
        "Liverpool James Street Rail Station",
        "Johnston (Pembrokeshire) Rail Station",
        "Johnstone Rail Station",
        "Jordanhill Rail Station",
        "Kirkcaldy Rail Station",
        "Kidderminster Rail Station",
        "Kearsley Rail Station",
        ...
        "Lairg Rail Station",
        "Lake (Isle of Wight) Rail Station",
        ...
        "Lichfield Trent Valley High Level Rail Station",
        ...
        "Liverpool Lime Street Low Level Rail Station",
        "Liverpool South Parkway Rail Station",
        ...
        "Manchester United FC Rail Station",
        ...
        "New Cross Gate ELL Rail Station",
        ...
        "Newtongrange Rail Station",
        "Newton for Hyde Rail Station",
        "Newton (S Lanarks) Rail Station",
        ...
        "Prestwick Rail Station",
        "Prestwick Intl Airport Rail Station",
        ...
        "Silverdale Rail Station",
        "Sudbury Hill Harrow Rail Station",
        "Sudbury & Harrow Road Rail Station",
        ...
        "Shotton High Level Rail Station",
        ...
        "Shoreham-by-Sea (Sussex) Rail Station",
        ...
        "Stratford-upon-Avon Parkway Rail Station",
        ...
        "Stansted Airport Rail Station",
        "Stansted Mountfitchet Rail Station",
        "Starbeck Rail Station",
        "St Annes-on-the-Sea Rail Station",
        "St Austell Rail Station",
        "Staveley Rail Station",
        ...
        "St James Park (Devon) Rail Station",
        "St James Street (London) Rail Station",
        "St Johns (London) Rail Station",
        ...
        "London St Pancras International Rail Station",
        "London St Pancras International LL Rail Station",
        ...
        "Tamworth High Level Rail Station",
        ...
        "West Byfleet Rail Station",
        "West Calder Rail Station",
        "Whitechapel Rail Station",
        "Whitchurch (Shrops) Rail Station",
        "Wickham Market Rail Station",
        "Westcliff-on-Sea Rail Station",
        ...
        "West Hampstead Thameslink Rail Station",
        ...
        "Willesden Junction Low Level Rail Station",
    ...
    public interface IPrefixTree {
        ...
        CompletableFuture<List<String>> findAsync(String prefix);
    ...
    public static class PrefixTree implements IPrefixTree {
        ...
        @Override
        public CompletableFuture<List<String>> findAsync(String prefix) {
            return CompletableFuture.supplyAsync(() -> find(prefix));
        }
        ...
        private class TreeNode {
            private final Map<Character, TreeNode> _treeNodes;

            public TreeNode() {
                _treeNodes = new HashMap<>();
            }
            ...
            public TreeNode getChild(char c) {
                if (_treeNodes.containsKey(c)) {
                    return _treeNodes.get(c);
                }
                return null;
            }

            public void addChild(TreeNode node) {
                _treeNodes.put(node.Char, node);
            }

            public List<String> getChildsTerms(String prefix) {
                ...
                for (TreeNode child : _treeNodes.values()) {
                    if (child.Char == '\0') {
                        terms.add(prefix);
                    } else {
                        terms.addAll(child.getChildsTerms(prefix + child.Char));
                    }
                }
